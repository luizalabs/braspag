...
class CaptureTest(BraspagTestCase):
    ...
    def test_acquirer_transaction_id(self):
        assert self.response.transactions[0]['acquirer_transaction_id'] == '1127023808906'
    ...
    def test_return_code(self):
        assert self.response.transactions[0]['return_code'] == '6'
    ...
    def test_status_message(self):
        assert self.response.transactions[0]['status_message'] == 'Captured'
